...
export const metadata: Metadata = {
  ...
  description:
    "Centro de danza y fitness en Hernani, Gipuzkoa. Clases de entrenamiento funcional, pilates, barrefit, power jump, fusión & ritmo, sevillanas, bachata, urbano y más.",
  icons: {
    icon: "/favicon.png",
